...
- VNET integrasjon er en Standard-tier feature i App Service Plan. Skifte App Service Plan: Trykk på "Scale Up". Velg så "S1" under "Production", den er legacy men fungerer fortsatt. Premium fungerer óg.
- Gå så til Networking i menyen til venstre. Trykk "Not configured" vid siden av Virtual Network Configuration.
- Trykk "Add virtual network integration" og velg det virtuelle nettverket du opprettet i forrige. Det har bare et subnet, så velg dette. Trykk OK. Nå har Web App'en din lov til å snakke med Storage Accounten gjennom VNET
